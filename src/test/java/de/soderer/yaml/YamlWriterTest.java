...
public class YamlWriterTest {
	@Test
	public void testYamlMappingPure() {
		try {
	...
	public void testYamlMappingFlow() {
		try {
			...
			testYamlValue.setStyle(YamlStyle.Flow);
			testYamlValue.addCommentLine("Mapping comment");
			testYamlValue.put(new YamlSimpleValue().setValue("property 1"), new YamlSimpleValue().setValue((String) null));
			...
			testYamlValue.put(new YamlSimpleValue().setValue("property 4"), new YamlSimpleValue().setValue("String value 1"));

			final YamlSequence otherYamlSequence = new YamlSequence();
			otherYamlSequence.setStyle(YamlStyle.Flow);
			otherYamlSequence.addCommentLine("Other mapping comment");
			otherYamlSequence.add(new YamlSimpleValue().setValue((String) null));
			...
			testYamlValue.put("Other sequence", otherYamlSequence);

			final YamlMapping otherYamlMapping = new YamlMapping();
			otherYamlMapping.setStyle(YamlStyle.Flow);
			otherYamlMapping.addCommentLine("Other mapping comment");
			otherYamlMapping.put(new YamlSimpleValue().setValue("property 31"), new YamlSimpleValue().setValue((String) null));
			...
			testYamlValue.put("Other mapping", otherYamlMapping);

			final String expectedString = ""
					+ "property 1: 1\n"
					+ "property 2: String value\n";
	...
	public void testYamlMappingBracket() {
		try {
			final YamlMapping testYamlValue = new YamlMapping();
			testYamlValue.setStyle(YamlStyle.Bracket);
			testYamlValue.addCommentLine("Mapping comment");
			testYamlValue.put(new YamlSimpleValue().setValue("property 1"), new YamlSimpleValue().setValue((String) null));
			testYamlValue.put(new YamlSimpleValue().setValue("property 2"), new YamlSimpleValue().setValue(true));
			testYamlValue.put(new YamlSimpleValue().setValue("property 3"), new YamlSimpleValue().setValue(1));
			...
			final YamlSequence otherYamlSequence = new YamlSequence();
			otherYamlSequence.setStyle(YamlStyle.Bracket);
			otherYamlSequence.addCommentLine("Other mapping comment");
			otherYamlSequence.add(new YamlSimpleValue().setValue((String) null));
			otherYamlSequence.add(new YamlSimpleValue().setValue(true));
			otherYamlSequence.add(new YamlSimpleValue().setValue(23));
			...
			final YamlMapping otherYamlMapping = new YamlMapping();
			otherYamlMapping.setStyle(YamlStyle.Bracket);
			otherYamlMapping.addCommentLine("Other mapping comment");
			otherYamlMapping.put(new YamlSimpleValue().setValue("property 31"), new YamlSimpleValue().setValue((String) null));
			otherYamlMapping.put(new YamlSimpleValue().setValue("property 32"), new YamlSimpleValue().setValue(true));
			otherYamlMapping.put(new YamlSimpleValue().setValue("property 33"), new YamlSimpleValue().setValue(33));
